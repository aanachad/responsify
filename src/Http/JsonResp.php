...
class JsonResp extends Resp
{
    ...
    public function bad_request($data=null) : JsonResponse{
        ...
        self::setResponseCode($data,eBaseResponseCode::_400_BAD_REQUEST);
    ...
    public function internal_error($data=null) : JsonResponse{
        self::setResponseCode($data,eBaseResponseCode::_500_INTERNAL_ERROR);
    ...
    public function unknown_error($data=null)  : JsonResponse{
        self::setResponseCode($data,eBaseResponseCode::_520_UNKNOWN_ERROR);
    ...
    public function guessResponse($response){
        ...
        switch ($code){
            ...
            case '404':
                ...
                break;
            case '406':
                return $this->not_acceptable($response);
                break;
            case '500':
